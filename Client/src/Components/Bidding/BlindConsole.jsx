      ...
      <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #06122c 0%, #020718 100%)', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1.5rem' }}>
          <div style={{ textShadow: '0 4px 10px rgba(0,0,0,0.3)', textAlign: 'center', color: '#fff', maxWidth: '500px' }}>
            <span style={{ fontSize: '5rem', marginBottom: '1.5rem', display: 'flex', justifyContent: 'center' }}>
              <svg width="80" height="80" viewBox="0 0 24 24" fill="none" stroke="#fece44" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ animation: 'spin 4s linear infinite' }}>
        ...
        <div className="console-grid-layout" style={{ alignItems: 'stretch' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            ...
            <div style={{
              ...
              {isSealed && lastEdited && (
                <div style={{ background: 'rgba(52, 211, 153, 0.05)', border: '1px solid rgba(52, 211, 153, 0.2)', padding: '0.6rem 1rem', borderRadius: '12px', fontSize: '0.78rem', color: '#a7f3d0', display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}>
                    <rect x="3" y="11" width="18" height="11" rx="2" ry="2" />
                    <path d="M7 11V7a5 5 0 0 1 10 0v4" />
                  </svg>
                  <span>Your sealed bid of <strong>₹{parseInt(maxBid, 10).toLocaleString()}</strong> was recorded on {new Date(lastEdited).toLocaleTimeString()}</span>
                </div>
              )}
            </div>
            ...
            <div style={{
              ...
              <h3 style={{ margin: '0 0 1rem', fontSize: '0.9rem', fontWeight: 800, color: '#fece44', textTransform: 'uppercase', letterSpacing: '0.04em', display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
              ...
              <form onSubmit={handlePlaceBlindBid} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                <div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.35rem' }}>
                    ...
                    <button
                      ...
                      style={{ background: 'none', border: 'none', color: '#fece44', fontSize: '0.75rem', fontWeight: 700, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.2rem' }}
                    >
                ...
                {TOTAL_BIDDING_POWER < item.startingPrice && (
                  <div style={{ color: '#fca5a5', fontSize: '0.75rem', background: 'rgba(239, 68, 68, 0.08)', border: '1px solid rgba(239, 68, 68, 0.2)', padding: '0.5rem 0.75rem', borderRadius: '8px', fontWeight: 600, display: 'flex', alignItems: 'start', gap: '0.4rem' }}>
                    ...
                    <span>Bidding locked. Your Bidding Power is lower than the starting price (₹{item.startingPrice?.toLocaleString()}). Please top up your wallet.</span>
                  </div>
                )}
                ...
                <div style={{ display: 'flex', gap: '0.75rem' }}>
                  {isSealed && (
                    <button
                      ...
                      style={{
                        ...
                        fontWeight: 700, fontSize: '0.9rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.3rem'
                      }}
                    >
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  >
                    {isSubmitting ? 'Encrypting...' : (isSealed ? (
                      <>
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                          <rect x="3" y="11" width="18" height="11" rx="2" ry="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" />
                        </svg>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            ...
            <div style={{
              ...
              <span style={{ fontSize: '0.7rem', textTransform: 'uppercase', letterSpacing: '0.1em', color: 'rgba(255,255,255,0.6)', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.3rem' }}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div style={{
              ...
              <h4 style={{ margin: '0 0 0.5rem', color: '#fece44', fontWeight: 800, display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
